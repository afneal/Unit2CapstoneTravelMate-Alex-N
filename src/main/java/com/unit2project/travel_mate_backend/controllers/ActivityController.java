...
public class ActivityController {
    ...
    public ResponseEntity<?> addNewActivity(@PathVariable int dayId, @RequestBody ActivityDTO activityData) {
        ...
        Day day = dayRepository.getReferenceById(dayId);//get day from db using URL path variable
